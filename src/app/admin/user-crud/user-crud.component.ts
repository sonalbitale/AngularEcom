...
export class UserCrudComponent implements OnInit {
  ...
  popup_header!:string;
  signInFormValue:any={}  //passed in object   <!-->  now will do grouping of form
...
this.all_user_data=data;
  ...
  this.addEditUserForm.reset(); // after form filling this method will reset the form
}
addUser(){
...
this.adminService.addUser(this.user_dto)
.subscribe((data)=>{
this.getAllUser();
JQuery('#addEditUserModal').modal('toggle');
},(error)=>{
  console.log("my wrong error",error);
})
}
...
this.adminService.editUser(this.edit_user_id,this.user_dto)
.subscribe(data=>{
this.getAllUser();
JQuery('#addEditUserModal').modal('toggle');
},error=>{
